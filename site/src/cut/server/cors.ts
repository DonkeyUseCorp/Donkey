 ...
 * Cut page is the only browser origin allowed to reach the engine cross-origin;
 * every other origin is refused before any handler runs.
 */
export const CUT_CLIENT_ORIGINS = new Set(["https://cut.donkeyuse.com"]);
