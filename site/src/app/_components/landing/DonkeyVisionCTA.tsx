        ...
        <div className="relative grid gap-8 rounded-2xl border-2 border-[#0F0E0D] bg-[#0F0E0D] p-8 text-white md:grid-cols-[minmax(0,1fr)_minmax(320px,0.56fr)] md:p-12">
          <div className="min-w-0">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <ContactSalesButton
                className="inline-flex min-h-14 items-center justify-center gap-2 rounded-full bg-white px-7 py-4 text-base font-semibold text-[#0F0E0D] transition hover:-translate-y-0.5"
              >
                Contact us
              </ContactSalesButton>
            </div>
