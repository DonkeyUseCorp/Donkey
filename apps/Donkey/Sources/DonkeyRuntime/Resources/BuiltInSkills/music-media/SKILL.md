...
For vague artist or genre playback requests, choose one concrete representative song or album before returning task JSON. Do not use an artist-only query for playback unless the user explicitly asks to open an artist page, artist albums, artist radio, station, or another browsing surface.
