...
- shows pause and resume controls for an active task in the expanded notch panel and routes them through the pointer-prompt command handler
...
- Expanded notch pause/resume controls should call the model/controller boundary and route through `PointerPromptCommandHandling`, keeping run coordination outside SwiftUI rendering.
